              ...
              <tr>
                ...
                <td class="th-font">
                  <?php if ($rowUsuarios['activo_login'] == 1) { ?>
                    <a class="dropdown">
                      <a class="dropdown-toggle btn btn-warning" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Accion
                      </a>
                      <ul class="dropdown-menu dropdown-menu-end menu-bg">
                        <li class="dropdown-item">
                          <form method="GET" action="editarUsuario.php">
                            ...
                            <button type="submit" class="btn btn-dropdown dropdown-item white-bg" name="editar"><i class="bi bi-pen"></i> Editar</button>
                          </form>
                        </li>
                        <!--
                        <li class="dropdown-item">
                          <form method="GET" action="permisos.php">
                            <input type="hidden" name="id_login" value="<?php //echo $rowUsuarios['id_login'] ?>">
                            <button type="submit" class="btn btn-dropdown dropdown-item white-bg"><i class="bi bi-person-rolodex"></i> Permisos</button>
                          </form>
                        </li>
                        -->
                        <li class="dropdown-item">
                          <form method="POST" action="../controllers/administradorController.php" class="deleteForm">
                            ...
                            <button type="submit" class="btn btn-dropdown dropdown-item white-bg" name="cambioUsuario">
